...
set my_verilog_files [list ../top.sv ../datapath.sv ../controller.sv]
...
set link_library [set target_library [concat  [list gscl45nm.db] [list dw_foundation.sldb] [list "../sram_32x64/SRAM_32x64_1rw.db"]]]
set target_library "gscl45nm.db ../sram_32x64/SRAM_32x64_1rw.db"
